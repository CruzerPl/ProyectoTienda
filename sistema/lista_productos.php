...
<body>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conn,"SELECT p.codproducto, p.descripcion, p.precio, p.existencia, pr.proveedor
                                        FROM producto p 
			...
			?>
				<tr class="row <?php echo $data["codproducto"]; ?>">
                    ...
                    <td>
						...
						<a class="link_add add_product" product="<?php echo $data["codproducto"]; ?>"href="#"><i class="far fa-plus"></i>Agregar</a>
						|
